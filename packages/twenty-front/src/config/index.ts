...
export const REACT_APP_NESTBOX_AI_INSTANCE_IP =
  window._env_?.REACT_APP_NESTBOX_AI_INSTANCE_IP ||
  process.env.REACT_APP_NESTBOX_AI_INSTANCE_IP;

export const REACT_APP_NESTBOX_AI_INSTANCE_API_KEY =
  window._env_?.REACT_APP_NESTBOX_AI_INSTANCE_API_KEY ||
  process.env.REACT_APP_NESTBOX_AI_INSTANCE_API_KEY;